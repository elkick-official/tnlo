...
import {
  calendarCityTypeOptions,
  calendarDistrictTypeOptions,
  calendarJurisdictionsTypeOptions,
  calendarLearderTypeOptions,
  calendarOrganizerTypeOptions,
  calendarProgramTypeOptions,
  calendarRepeatTypeOptions,
  calendarStationTypeOptions,
  calendarZoneTypeOptions,
} from "../../const/data";
...
export const TNCalendarAddProgramModal = () => {
  ...
  const handleSwitchChange =
    (key: "Publish" | "unpublished") => (checked: boolean) => {
  ...
  return (
    <>
      ...
      <Modal
        ...
        onOk={handleAddProgramOk}
        onCancel={handleAddProgramCancel}
        centered
        width={845}
      ...
      >
        ...
        <div className="flex items-center justify-space-between gap-5 flex-wrap">
          <TNDatePicker
            label="Program State date and End Date"
            showTimeOption={true}
            options={[]}
          />
